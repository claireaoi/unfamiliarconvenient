...
def createGraph():
    ...
    weightNode=dict(selfGraph.key())
    for node in selfGraph.key():#extract weights Node only
        weightNode[node]=selfGraph[node][0]
