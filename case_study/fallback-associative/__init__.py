...
config={
    ...
    "opinion_length": 130, #length opinion generated by gpt2
    "opinion_length_variance": 30, #vairnace of the length of that opinion
    "max_pick_word": 20,
    "scraping_min_length": 100, #min char where think is good length
...
class AssociativeFallback(FallbackSkill):
    ...
    def __init__(self):
        ...
        self.MSG_ASKOPINION, self.MSG_COMETOGETHER, self.MSG_COMETOGETHER3, self.MSG_INTEREST, self.MSG_LETMETHINK, self.MSG_NOINTEREST, self.MSG_SHARE, self.MSG_NOTED, self.MSG_PROCESS=[], [], [], [], [], [], [], [], []
        self.load_messages()
    ...
    def handle_associative(self, message):
        ...
        if no_new_concept or (not if_added_concept):
            ...
            if human_opinion is not None:#do not need both, check new utterance not same than old one...
                ...
                self.speak(random.choice(self.MSG_PROCESS))
                ...
                OPINION=["In my opinion", "Yet, I think", "I think", "I tend to think that", "I suppose", "I guess"]
                ...
                #---gpt2 generation
                opinion = self.gpt2_text_generation(context, seed, length_output, temperature_gpt2) 
                ...
                self.speak("Thank you. I will remember that.")
...
#***********************************************************************************************************************************************
    ...
    def surf_google(self,query, maximum_char_extract):
        ...
        final_extract = self.clean_text(final_extract)
...
#***********************************************************************************************************************************************
    ...
    def load_messages(self):
        ...
        self.MSG_PROCESS=load_data_txt("message_process.txt", path_folder=path_folder)
...
#************************************************************************************************************************************
    ...
    def gpt2_text_generation(self, context, seed, length_output, temperature): 
        """
        ...
        drift = drift.replace(seed, "")
        drift = self.clean_text(drift)
